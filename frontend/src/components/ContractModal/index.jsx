          ...
          <div className="contract-scroll">
            <article className="contract-paper">
              <p className="contract-intro">
                ...
                CONTRATADA, e de outro o(a) TUTOR(A)/RESPONSÁVEL LEGAL PELO PET,
                abaixo identificado(a), doravante denominado(a) CONTRATANTE, têm
              ...
              <ContractSection number="1." title="OBJETO">
                <p>
                  ...
                  CONTRATANTE, conforme pacote e período previamente acordados e
                  descriminados no final deste contrato.
                </p>
              </ContractSection>
              ...
              >
                <ol>
                  ...
                  <li>
                    ...
                    com receituário de profissional de saúde animal), estado de
                    saúde e eventuais recomendações/orientações.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    dificuldades sejam quais forem, ou mudanças comportamentais.
                  </li>
                  <li>
              ...
              <ContractSection number="3." title="SÃO DIREITOS DA CONTRATADA">
                <ol>
                  <li>
                    Não aceitar animais que não se adaptem à permanência em suas
              ...
              <ContractSection number="4." title="SÃO DEVERES DO CONTRATANTE">
                <ol>
                  <li>
                    Informar, na ficha de check-in, todos os seus dados pessoais
                    e de contato (protegidos pela LGPD), inclusive para
                    emergências, como autorização prévia e formal para que
                    terceiros retirem o pet caso exista essa possibilidade.
                  </li>
                  <li>
                    Identificação de todos os pertences do pet quando da entrega
                    no check-in.
                  </li>
                  <li>
                    Fornecer comprovante de que o pet encontra-se clinicamente
                    saudável, com vacinação (atestado de vacina atualizado:
                    mínimo de 20 dias de vacinação com as vacinas V10 e raiva e
                    15 dias da vacina de gripe canina), vermifugação e controle
                    de ectoparasitas em dia (aplicação de
                  ...
                  <li>
                    Informar, com antecedência mínima de 24 horas, a intenção de
                    prorrogar a permanência do pet e qual o período desejado,
                    quitando de imediato e integralmente a nova contratação. A
                    não comunicação acarretará acréscimo de 50% (cinquenta por
                    cento) no valor da diária, haja vista a possível perda de
                    reserva de outros hóspedes.
                  </li>
                  <li>
                    Pagamento das obrigações financeiras (incluindo as elencadas
                    na cláusula 3) e arcar com quaisquer despesas extras
                    prestadas por terceiros, desde que autorizadas (banho e
                    tosa, transporte, medicamentos do pet, etc.), inclusive
                    danos às instalações comprovadas pela CONTRATADA. Tais
                    despesas deverão ser quitadas no check-out e o atraso poderá
                    acarretar multa de 2% e juros de 0,33% ao dia limitado a 10%
                    ao mês.
                  </li>
                  <li>
              ...
              <ContractSection number="5." title="SÃO DIREITOS DO CONTRATANTE">
                <ol>
                  <li>
                  ...
                  <li>
                    ...
                    informações gerais sobre a adaptação, rotina e bem-estar do
                    pet durante o período de hospedagem ou creche, dentro dos
                    horários e canais estabelecidos pela CONTRATADA.
                  </li>
                  <li>
                    À transparência: o CONTRATANTE tem direito à clareza prévia
                    quanto às regras, funcionamento, valores, pacotes, horários,
                    políticas internas e limites dos serviços oferecidos pela
                    Mel Pet Hostel.
                  </li>
                  <li>
                    À individualidade do pet: a CONTRATADA compromete-se a
                    respeitar as características individuais do pet, dentro das
                    possibilidades do serviço contratado e sem garantia de
                  ...
                  <li>
                    ...
                    direito de autorizar ou não o uso da imagem do pet para fins
                    institucionais e publicitários da Mel Pet Hostel, conforme
                    termo específico.
                  </li>
                  <li>
              ...
              <ContractSection number="6." title="RISCOS INERENTES À ATIVIDADE">
                <ol>
                  <li>
                    O(a) CONTRATANTE está ciente de que atividades em grupo,
                    convivência com outros animais e ambientes abertos envolvem
                    riscos naturais, tais como:
                    <div className="contract-note">
                      <ul className="contract-note-list">
                        ...
                        <li>
                          Alterações intestinais leves decorrentes de adaptação.
                        </li>
                      </ul>
                    </div>
                  </li>
              ...
              <ContractSection number="7." title="DO FUNCIONAMENTO">
                <ol>
                  <li>
                    ...
                    50% (cinquenta por cento) restantes deverão ser pagos no ato
                    do check-in. Não haverá devolução de valores por interrupção
                    da permanência antes do final da reserva.
                  </li>
                  <li>
                    O horário para check-in e check-out é das 8h às 18h em dias
                    úteis e das 10h às 15h aos finais de semana e feriados. Não
                    serão aceitas entradas/saídas fora desses horários.
                  </li>
                </ol>
              </ContractSection>
              ...
              <ContractSection number="8." title="RESPONSABILIDADE">
                <ol>
                  <li>
                    ...
                    criminalmente, por quaisquer ocorrências não decorrentes de
                    dolo ou negligência comprovada, bem como isenta,
                    expressamente, a CONTRATADA de qualquer responsabilidade por
                    danos físicos, emocionais ou comportamentais decorrentes da
                    adaptação do pet. A omissão, inexatidão ou falsidade de
                    informações relativas à saúde, comportamento ou temperamento
                    do pet, por parte do CONTRATANTE o tornará integralmente
                    responsável por quaisquer danos causados pelo pet (e suas
                    ações), instalações ou aos demais hóspedes, salvo nos casos
                    de comprovada negligência ou descumprimento contratual por
                    parte da CONTRATADA.
                  </li>
                  <li>
                    Em caso de situação emergencial ou de urgência, que possa
                    representar risco à vida do pet, a Mel Pet Hostel fica desde
                    já expressamente autorizada a encaminhar o animal para
                    clínica veterinária a mais próxima e de sua confiança,
                    visando a preservação da integridade física e do bem-estar
                    do pet.
                  </li>
                  <li>
                    O(a) TUTOR(A)/RESPONSÁVEL LEGAL declara estar ciente de que
                    todos os custos decorrentes do atendimento veterinário,
                    incluindo, mas não se limitando a consultas, exames,
                    internações, procedimentos, medicamentos e transporte, serão
                    de inteira e exclusiva responsabilidade do(a) tutor(a).
                  </li>
                  <li>
                    A Mel Pet Hostel compromete-se a comunicar o tutor(a) o mais
                    breve e assim que possível, não sendo responsabilizada por
                    eventuais decisões clínicas adotadas pelo médico veterinário
                    responsável, tampouco por desfechos decorrentes do quadro
                    clínico do animal, desde que não haja dolo ou negligência
                    comprovada por parte da Mel Pet Hostel.
                  </li>
                  <li>
                    ...
                    <div className="contract-subitems">
                      <p>
                        ...
                        que a presença de fêmea em período de estro (cio) em
                        ambiente de convivência com outros pets, especialmente
                        machos, pode gerar comportamentos instintivos, tais como
                        agitação, disputas, tentativas de monta, brigas e
                        eventuais ferimentos.
                      </p>
                      <p>
                        Fica expressamente estabelecido que, em caso de
                        conflitos, brigas, acidentes, ferimentos, necessidade de
                        atendimento veterinário, uso de medicamentos,
                      ...
                      <p>
                        ...
                        responsabilizada, civil ou criminalmente, por quaisquer
                        danos, custos ou desdobramentos, desde que não haja dolo
                        ou negligência comprovada por parte da CONTRATADA.
                      </p>
                      <p>
                      ...
                      <p>
                        Todos os custos veterinários, tratamentos, medicamentos,
                        exames e demais despesas eventualmente necessários em
                        razão de tais ocorrências serão de inteira
                        responsabilidade do(a) tutor(a) da fêmea em estro (cio).
                      </p>
                    </div>
                  </li>
                </ol>
              ...
              <ContractSection number="9." title="DISPOSIÇÕES FINAIS">
                <ol>
                  <li>
                    Este contrato entra em vigor a partir da data da assinatura.
                  </li>
                  <li>
                    O foro eleito para dirimir quaisquer dúvidas é o da comarca
                    do estabelecimento da CONTRATADA.
                  </li>
                </ol>
              </ContractSection>
